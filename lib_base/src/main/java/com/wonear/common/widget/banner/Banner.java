...
import com.wonear.common.widget.banner.listener.OnBannerClickListener;
import com.wonear.common.widget.banner.listener.OnBannerListener;
import com.wonear.common.widget.banner.loader.GlideImageLoader;
import com.wonear.common.widget.banner.loader.ImageLoaderInterface;
import com.wonear.common.widget.banner.view.BannerViewPager;
...
public class Banner extends FrameLayout implements OnPageChangeListener {
    ...
    public Banner start() {
        if (imageLoader == null) imageLoader = new GlideImageLoader();
        setBannerStyleUI();
            ...
            if (bannerListener != null) {
                view.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View v) {
                        LogUtil.e(tag, "你正在使用旧版点击事件接口，下标是从1开始，" +
...
//        Log.i(tag,"currentItem: "+currentItem);
    ...
    public void showImages(List<String> urlList) {
        setImages(urlList)
                .setImageLoader(new GlideImageLoader())
                .start();
    }

    public void showDrawables(List<Integer> urlList) {
        setImages(urlList)
                .setImageLoader(new GlideImageLoader())
                .start();
    }
