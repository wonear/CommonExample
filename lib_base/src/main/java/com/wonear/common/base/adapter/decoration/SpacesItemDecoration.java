package com.wonear.common.base.adapter.decoration;
...
public class SpacesItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public SpacesItemDecoration(float topBottom) {
        this.leftRight = 0;
        this.topBottom = DimensionUtil.dip2px(topBottom);
        mColor = Color.parseColor("#F5F5F5");
    }

    public SpacesItemDecoration(float leftRight, float topBottom) {
        this.leftRight = DimensionUtil.dip2px(leftRight);
        this.topBottom = DimensionUtil.dip2px(topBottom);
        mColor = Color.parseColor("#F5F5F5");
    }

    public SpacesItemDecoration(float leftRight, float topBottom, int mColor) {
